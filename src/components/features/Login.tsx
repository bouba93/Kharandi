            ...
            {step === 'phone' && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
                ...
                <div className="relative flex py-1 items-center">
                  ...
                  <span className="flex-shrink mx-4 text-slate-400 text-[11px] font-bold uppercase">ou</span>
                  <div className="flex-grow border-t border-slate-200"></div>
                </div>

                <a
                  href="https://api.kharandi.gn/api/v1/auth/google/login/?platform=web"
                  className="w-full py-3.5 px-4 rounded-[20px] font-bold text-xs bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 shadow-xs flex items-center justify-center gap-3 transition-all cursor-pointer"
                >
